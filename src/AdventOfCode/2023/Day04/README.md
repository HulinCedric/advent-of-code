...
me with something quick, I'll let you **borrow my boat** and you can go visit the gardener. I got all
...
of **winning numbers**. The first match makes the card worth **one point** and each match after the first **doubles** the
...
and `86`) are winning numbers! That means card 1 is worth **`8`** points (1 for the first match, then doubled three
