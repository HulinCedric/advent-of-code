...
public class PipeShould
{
    ...
    [Theory]
    [InputFileData("2023/Day10/sample1.txt", 1)]
    [InputFileData("2023/Day10/sample2.txt", 1)]
    [InputFileData("2023/Day10/sample3.txt", 4)]
    [InputFileData("2023/Day10/sample4.txt", 4)]
    [InputFileData("2023/Day10/sample5.txt", 8)]
    [InputFileData("2023/Day10/sample6.txt", 10)]
