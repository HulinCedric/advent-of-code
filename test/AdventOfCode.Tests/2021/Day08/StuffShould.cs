...
{
    [Theory]
    [InputFileData("2021/Day08/sample.txt", 26)]
    [InputFileData("2021/Day08/input.txt", 344)]
    ...
    [Theory]
    [InputFileData("2021/Day08/sample.txt", 61229)]
    [InputFileData("2021/Day08/input.txt", 1048410)]
